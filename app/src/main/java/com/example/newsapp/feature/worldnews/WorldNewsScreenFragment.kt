...
class WorldNewsScreenFragment : Fragment(R.layout.fragment_world_news) {

    private val viewModel: WorldNewsViewModel by viewModel()
    ...
    private val adapter: WorldNewsAdapter by lazy {
        WorldNewsAdapter(
